...
export default function CustomizedStatement() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (getData.length > 0) {
      Store.addNotification({
        title: "Account Number Valid",
        message: "Your Transactions are displayed below",
        type: "info",
  ...
  return (
    <>
      <h3 className="my-4">Customized Statement</h3>
